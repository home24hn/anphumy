...
export const en: Dictionary = {
  ...
  contactPage: {
    ...
    subtitle: "Talk to APM Tech",
    intro:
      "Send us information about the system you need to deploy, upgrade, or maintain. APM Tech – An Phu My Development Joint Stock Company will get in touch to discuss your needs and a suitable approach.",
    ...
    form: {
      ...
      need: "Need",
      needPlaceholder: "Select an area to discuss",
      needOptions: [
        "Security & CCTV",
        "Network Infrastructure",
        "Access Control",
      ...
      messagePlaceholder: "Briefly describe your need, current setup, or facility to deploy.",
      submit: "Send request",
      submitting: "Sending...",
